...
-- Creado: 25/08/2024
-- Ultima actualizacion: 17/11/2024
...
CREATE TABLE DIM_PROVEEDOR(
	PROVEEDOR_KEY BIGINT IDENTITY(1,1) PRIMARY KEY,
	PROVEEDOR_ID BIGINT NOT NULL,
	NOMBRE_PROVEEDOR VARCHAR(100) NOT NULL DEFAULT 'N/A',
...
CREATE TABLE FACT_ACTIVO_FIJO(
	...
	PROVEEDOR_KEY BIGINT NOT NULL FOREIGN KEY REFERENCES DIM_PROVEEDOR(PROVEEDOR_KEY),
...
ALTER TABLE DW_PARAMETROS 
ADD CONSTRAINT DW_PARAMS_UN_NAME UNIQUE (NOMBRE_PARAM);
GO

INSERT INTO DW_PARAMETROS (NOMBRE_PARAM, VALOR_PARAM) 
VALUES (N'ULTIMA_EJECUCION', N'2024-01-01');
GO
